...
const char* serverUrl = "https://airpollution.b2lsolutions.in/api/v1/AirPollution"; 
...
//  lcd.clear(); 
  ...
  delay(2000);
    ...
    if((millis()-oldtime)>55000)
    {
    jsonData = "{\"co\":\""+String(gas_mq2)+"\",\"nO2\": \""+String(gas_mq3)+"\",\"sO2\": \""+String(gas_mq4)+"\",\"horizon\": 1}";
