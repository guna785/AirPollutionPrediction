using AirPollutionPrediction.API.Localization;
using AirPollutionPrediction.API.Managers.Preferences;
using AirPollutionPrediction.API.Services;
using AirPollutionPrediction.API.Settings;
...
using AirPollutionPrediction.Infra.Shared.Services;
using AirPollutionPrediction.Infrastructure;
using AirPollutionPrediction.Infrastructure.Contexts;
using AirPollutionPrediction.Infrastructure.Models.Identity;
using AirPollutionPrediction.Infrastructure.Services;
using AirPollutionPrediction.Infrastructure.Services.Identity;
    ...
    internal static class ServiceCollectionExtensions
    {
        ...
        internal static void RegisterSwagger(this IServiceCollection services)
        {
            _ = services.AddSwaggerGen(async c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "AirPollutionPrediction.API",
