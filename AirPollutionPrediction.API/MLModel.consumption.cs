...
namespace AirPollutionPrediction_API
{
    public partial class MLModel
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"co_LB")]
            public float[] Co_LB { get; set; }

            [ColumnName(@"co_UB")]
            public float[] Co_UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"C:\Users\hp\Source\Repos\guna785\AirPollutionPrediction\AirPollutionPrediction.API\MLModel.zip");
