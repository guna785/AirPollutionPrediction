...
namespace AirPollutionPrediction.API.Controllers.Identity
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            AirPollutionPrediction.Shared.Wrapper.Result<List<AirPollutionPrediction.Application.Responses.Identity.UserResponse>> users = await _userService.GetAllAsync();
            return Ok(users);
        }
        ...
        {
            AirPollutionPrediction.Shared.Wrapper.IResult<AirPollutionPrediction.Application.Responses.Identity.UserResponse> user = await _userService.GetAsync(id);
            return Ok(user);
        }
        ...
        {
            AirPollutionPrediction.Shared.Wrapper.IResult<AirPollutionPrediction.Application.Responses.Identity.UserRolesResponse> userRoles = await _userService.GetRolesAsync(id);
            return Ok(userRoles);
        }
