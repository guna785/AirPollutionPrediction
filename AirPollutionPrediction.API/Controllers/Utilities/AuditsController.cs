...
namespace AirPollutionPrediction.API.Controllers.Utilities
{
    ...
    public class AuditsController : ControllerBase
    {
        ...
        {
            AirPollutionPrediction.Shared.Wrapper.IResult<string> data = await _auditService.ExportToExcelAsync(_currentUserService.UserName, searchString, searchInOldValues, searchInNewValues);
            return Ok(data);
        }
    }
}
