...
namespace AirPollutionPrediction_API
{
    public partial class SO2
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"so2_LB")]
            public float[] So2_LB { get; set; }

            [ColumnName(@"so2_UB")]
            public float[] So2_UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"C:\Users\hp\Source\Repos\guna785\AirPollutionPrediction\AirPollutionPrediction.API\SO2.zip");
